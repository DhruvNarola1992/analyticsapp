...
export class OtherComponent  {
  ...
  async userActivityByApps(show) {
    this.rowData = show;
    const dialogRef = this.matDialog.open(DeActiveActivityByAppsHistoryDialog, {
      height: 'auto',
      width: 'auto',
      disableClose: true,
      hasBackdrop: true,
  ...
  async userDelete(show) {
    this.rowData = show;
    const dialogRef = this.matDialog.open(DeUserDeleteDialog, {
      height: 'auto',
      width: 'auto',
      disableClose: true,
      hasBackdrop: true,
...
@Component({
  selector: 'user-deactivity-apps-history-dialog',
  templateUrl: 'activity-user-app.html',
})

export class DeActiveActivityByAppsHistoryDialog implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DeActiveActivityByAppsHistoryDialog>,
...
export class DeUserDeleteDialog implements OnInit {
  form: FormGroup;

  constructor(public formBuilder: FormBuilder, public dialogRef: MatDialogRef<DeUserDeleteDialog>,
    @Inject(MAT_DIALOG_DATA) public data: User, private userService: UserService) {
  }
